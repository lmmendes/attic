...
func Load() (*Config, error) {
	sessionSecret := os.Getenv("ATTIC_SESSION_SECRET")
	...
	if sessionSecretEphemeral {
		...
		sessionSecret = base64.RawURLEncoding.EncodeToString(secretBytes)
	}
	...
	cfg := &Config{
		...
		SessionSecretEphemeral: sessionSecretEphemeral,
